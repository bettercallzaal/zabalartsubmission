...
const MESSAGE_VARIANTS = {
    ...
    streamAndClient: [
        // Direct & Personal (12 variants)
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I want @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I'm voting for @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client} this week`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. That's my vote`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I want @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. Let's go`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I'm voting for @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client} today`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client} 🎨`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. My votes`,
        
        // Casual & Enthusiastic (12 variants)
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}! Who's with me?`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I want @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. It'd be fire 🔥`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should totally do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I'm voting for @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. Let's make it happen`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. No cap`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. That's the move`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I want @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. Hits different`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. This is it`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. I'm all in`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I'm voting for @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. LFG`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. That's the vibe`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. My picks for sure`,
        
        // Explanatory & Thoughtful (12 variants)
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. Makes the most sense`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I want @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. It's the right call`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. Best combo imo`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I'm voting for @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. Smart play`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. Feels right`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. That's my take`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I want @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. Good timing`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. Clear choice`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. I'm confident`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I'm voting for @zaal to do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. Here's why`,
        (modeEmoji, mode, platformEmoji, platform, client) => `I think @zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} via ${client}. Solid move`,
        (modeEmoji, mode, platformEmoji, platform, client) => `@zaal should do ${modeEmoji} ${mode} stream and focus on ${platformEmoji} ${platform} on ${client}. That's what I'm thinking`
    ],
    generic: [
